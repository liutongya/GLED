...
C These options allow a constant mean flow to be added
#ifdef OFFLINE_MEAN_FLOW
      COMMON /OFFLINE_MEANFLOW_FIELDS/
     &       UMeanFile, VMeanFile, WMeanFile,
     &       uvelmean, vvelmean, wvelmean
      CHARACTER*(MAX_LEN_FNAM) UMeanFile
      CHARACTER*(MAX_LEN_FNAM) VMeanFile
      CHARACTER*(MAX_LEN_FNAM) WMeanFile
      _RS  uvelmean (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RS  vvelmean (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RS  wvelmean (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
#endif /* OFFLINE_MEAN_FLOW */
